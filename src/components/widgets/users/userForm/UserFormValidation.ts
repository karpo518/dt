...
export const getUserFormSchema = (
  ...
  return Yup.object().shape({
    ...
    lastName: Yup.string().required("Фамилия не заполнена!"),
    roles: Yup.array()
      .of(Yup.string().oneOf(roleValues))
      .min(1, "Выберите хотя бы ${min} вариант"),
    workBorders: Yup.array()
      .of(Yup.string().oneOf(workBordersValues))
      .min(1, "Выберите хотя бы ${min} вариант"),
  });
};
